...
const AddMovie = () => {
  ...
  const changeName = (e) => setMovieName(e.target.value);
  const changeImage = (e) => setMovieImage(e.target.value);
  const changeRaiting = (e) => setMovieRaiting(e.target.value);
  const changeDescription = (e) => setMovieDescription(e.target.value);
